...
export default function PricingSection() {
  ...
  return (
    // Removed the massive 80px padding so it fits neatly in the dashboard container
    <div style={{ width: '100%', animation: 'fadeIn 0.3s ease-in-out' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ fontSize: '16px', color: '#4b5563', maxWidth: '600px', margin: '0 auto 20px auto' }}>Choose the perfect plan for yourself or scale up to manage your entire global team.</p>
